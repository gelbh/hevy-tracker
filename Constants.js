...
const SHEET_HEADERS = {
  [WORKOUTS_SHEET_NAME]: [
    ...
    'Exercise', 'Set Type', 'Weight (kg)', 'Reps', 
    'Distance (m)', 'Duration (s)', 'RPE'
  ],
  [ROUTINES_SHEET_NAME]: [
    'ID', 'Title', 'Folder ID', 'Exercise', 
    'Set Type', 'Weight (kg)', 'Reps'
  ],
  [EXERCISES_SHEET_NAME]: [
    'ID', 'Title', 'IMG', 'Type', 'Primary Muscle Group',
    'Secondary Muscle Groups', 'Is Custom', 'Count', 'Rank'
  ],
